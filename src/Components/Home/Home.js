            ...
            <div class="card-body">
              <div className="row">
                <div className="col-3">
                  <div className="card text-center m-2">
                    <div className="card-title text-center">
                      <h1>{cluster ? cluster.length : 0}</h1>
                    </div>
                ...
                <div className="col-3">
                  <div className="card text-center m-2">
                    <div className="card-title text-center">
                      <h1>{start ? start.length : 0}</h1>
                    </div>
                    <div className="card-body text-center">
                      <span class="greendot"></span>&emsp;Active{" "}
                    </div>
                  </div>
                </div>
                <div className="col-3">
                  <div className="card text-center m-2">
                    <div className="card-title text-center">
                      <h1>{reboot ? reboot.length : 0}</h1>
                    </div>
                    <div className="card-body text-center">
                      <span class="orangedot"></span>&emsp;Reboot{" "}
                    </div>
                  </div>
                </div>
                <div className="col-3">
                  <div className="card text-center m-2">
                    <div className="card-title text-center">
                      <h1> {stop ? stop.length : 0}</h1>
                    </div>
                    <div className="card-body text-center">
                      {" "}
                      <span class="reddot"></span>&emsp;Inactive{" "}
                    </div>
                  </div>
                </div>
                <br />
                ...
                <div class="list-group">
                  {cluster.map((obj) => {
                    return (
                      ...
                      >
                        Cluster Name - <strong>{obj.clusterName} </strong>
                        <br />
                    ...
                    <form>
                      <div class="form-group">
                        ...
                        <select
                          id="cluster-name"
                          class="form-control"
                          onChange={(e) => setchooseclusterName(e.target.value)}
                        >
